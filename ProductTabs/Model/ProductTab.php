...
use Divya\ProductTabs\Api\Data\ProductTabExtensionInterface;
...
{
    const CACHE_TAG = 'divya_product_tabs';

    protected $_cacheTag = 'divya_product_tabs';

    protected $_eventPrefix = 'divya_product_tabs';
