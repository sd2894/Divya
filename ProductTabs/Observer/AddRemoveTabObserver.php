 ...
 */
namespace Divya\ProductTabs\Observer;

use Divya\ProductTabs\Helper\Data;
use Divya\ProductTabs\Model\ProductTab;
use Divya\ProductTabs\Model\ResourceModel\ProductTab\CollectionFactory as TabFactory;
use Exception;
        ...
        if ($tabWrapper) {
            ...
            foreach ($tabCollection as $tab) {
                ...
                $layout->getBlock('product-tab' . $tab->getId())
                    ->setTemplate('Divya_ProductTabs::renderer.phtml')
